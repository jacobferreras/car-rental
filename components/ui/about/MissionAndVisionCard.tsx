...
const MissionAndVisionCard = (props: MissionAndVisionCardProps) => {
  return (
    <>
      <div className="card bg-base-100 w-auto md:h-100 xl:h-90 lg:w-110 xl:w-160 shadow-sm">
        ...
        <div className="card-body items-center text-center">
          ...
          <p className="font-family-sans text-xs md:text-md lg:text-lg xl:text-xl text-justify ">
            {props.description}
          </p>
        </div>
      </div>
